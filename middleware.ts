...
const accessControl: Record<string, string[]> = {
  ...
  STUDENT: ["/courses", "/profile","/student/student-dashboard","/student/dashboard","/super_admin","/my-courses"],
};

// ==========================
//  PUBLIC ROUTES
// ==========================
const publicRoutes = ["/", "/auth/student_login", "/auth/student_signup","/auth/superadmin_login"];
